...
<tr>	
	<td colspan="2" style="font-size: 22px;font-weight: bold;"> 제 목 : <%=dto.getTitle() %></td>
</tr>
<tr>
	<th>작성자</th>
	<td><%=dto.getId() %></td>
...
<br>
<button type="button" class="btn btn-primary" onclick="location.href='bbsanswer.do?seq=<%=dto.getSeq() %>'">답글</button>
